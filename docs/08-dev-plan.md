...
- **Remaining in P1 (1c):** BGE-M3 embeddings → Chroma adapter (behind `VectorStore`) + reranker + `embed` stage + retrieval over chunks/claims; front-loaded gold + adversarial eval set (1 EN + 1 HU); retrieval A/B → MLflow.
